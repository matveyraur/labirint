...
class Player(GameSprite):
    ...
    def update(self):
        if self.speed_x < 0 and self.rect.left > 0 or self.speed.x > 0 and self.right < WIN_WIDTH:
            self.rect.x += self.speed_x
        if self.speed_y > 0 and self.rect.top > 0:
            self.rect.y += self.speed_y


player = GameSprite(20, 0, 75, 75, r"images\player.jpg")
enemy = GameSprite(350, 250, 100, 150, r"images\enemy.png")
chest = GameSprite(330, 150, 100, 100, r"images\chest.png")
